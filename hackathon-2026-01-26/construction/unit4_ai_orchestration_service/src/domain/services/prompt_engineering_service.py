...
class PromptEngineeringService:
    ...
    SYSTEM_PROMPT_NO_DOCS = (
        ...
        "If this appears to be a follow-up question (e.g., 'it's not working', 'I tried that'), respond with:\n"
        "\"I understand the previous solution didn't work for you. Could you please describe:\n"
        "1. What specific step failed?\n"
        "2. What error message (if any) did you see?\n"
        "3. What exactly happened when you tried?\n\n"
        "This will help me search for more specific documentation or escalate to the right team.\"\n\n"
        "For other queries, respond with:\n"
